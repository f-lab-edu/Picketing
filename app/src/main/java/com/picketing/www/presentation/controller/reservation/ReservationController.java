...
public class ReservationController {
	...
	@PostMapping("/make")
	public MakeReservationResponse makeReservationWithRequest(@RequestBody ReservationRequest requestDto) {
		return reservationFactory.convertReservationToResponse(
			reservationService.makeReservations(userService.get(
					requestDto.userId()), showService.getShowById(requestDto.showId()), requestDto.showTime(),
				requestDto.seatGradeList())
		);
	}
}
