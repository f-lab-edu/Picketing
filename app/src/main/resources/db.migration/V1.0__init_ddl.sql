...
DROP TABLE IF EXISTS `RESERVATION`;
DROP TABLE IF EXISTS `SCHEDULED_SHOW_SEAT`;
DROP TABLE IF EXISTS `USERS`;
DROP TABLE IF EXISTS `SHOWS`;
...
ALTER TABLE `SCHEDULED_SHOW_SEAT`
    ADD CONSTRAINT `FK_SHOW_TO_SCHEDULED_SHOW_SEAT` FOREIGN KEY (
                                                                 `show_id`
        )
        REFERENCES `SHOWS` (
                            `id`
...
ALTER TABLE `RESERVATION`
    ADD CONSTRAINT `FK_USER_TO_RESERVATION` FOREIGN KEY (
                                                         `user_id`
        )
        REFERENCES `USERS` (
                            `id`
...
ALTER TABLE `RESERVATION`
    ADD CONSTRAINT `FK_SCHEDULED_SHOW_SEAT_TO_RESERVATION` FOREIGN KEY (
                                                                        `scheduled_show_seat_id`
        )
        REFERENCES `SCHEDULED_SHOW_SEAT` (
                                          `id`
            );
